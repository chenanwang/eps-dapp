...
|---|---|---|---|---|---|
| T-001 | Repo hygiene: .gitignore, .github/ (CI workflow, claude workflow, phase-gate PR template), devcontainer.json | Devcontainer pins Node 20, pnpm, Solana CLI, Stripe CLI; PR template has gate checklist | NOT STARTED | | |
